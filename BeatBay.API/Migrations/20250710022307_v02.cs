    ...
    public partial class v02 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaybackStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlaybackStatistics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PlaybackStatistics_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, null, "Admin", "ADMIN" },
                    { 2, null, "Artist", "ARTIST" },
                    { 3, null, "User", "USER" }
                });

            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "MaxConnections", "Name", "PriceUSD" },
                values: new object[,]
                {
                    { 1, 1, "Free", 0m },
                    { 2, 1, "Personal", 1m },
                    { 3, 4, "Familiar", 3.50m },
                    { 4, 50, "Empresarial", 35m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaybackStatistics_UserId",
                table: "PlaybackStatistics",
                column: "UserId");
